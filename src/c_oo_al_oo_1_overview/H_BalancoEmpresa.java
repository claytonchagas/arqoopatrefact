...
public class H_BalancoEmpresa {
	private HashMap<String, G_Divida> dividas = new HashMap<String, G_Divida>();

	public void registraDivida(String credor, String cnpjCredor, double valor) {
		G_Divida divida = new G_Divida();
	...
	public void pagaDivida(String cnpjCredor, double valor) {
		G_Divida divida = dividas.get(cnpjCredor);
		if (divida != null) {
//			if (valor > 100) {
//				valor = valor - 8;
//			}
